    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>首页Banner</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="handle-box">
        	<router-link to="/addbanlinefun/5/-1">
            	<el-button type="primary" class="handle-del mr10" @click="delAll">新增Banner</el-button>
       		</router-link>
        </div>
        <!-- ref="multipleTable"-->
        <el-table :data="testData" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column align="center" label="模板图片" min-width="180">
            ...
            <el-table-column align="center" label="操作" width="180">
                <template scope="scope">
                	<router-link :to="'/addbanlinefun/5/'+scope.row.Id">
...
<script>
    export default {
        ...
        methods: {
        	//get为例子  
            myaxios: function() { 
                this.$http.post(this.HOST+"/template/Query",{qu:{index:this.cur_page,size:10},TemplateType:5})  
                .then(response => {  
