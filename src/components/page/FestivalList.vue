    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>节日模板</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="handle-box">
       		<router-link to="/template/2/-1">
            	<el-button type="primary" icon="delete" class="handle-del mr10">新增节日模板</el-button>
            </router-link>
        </div>
        <!-- ref="multipleTable"-->
        <el-table :data="testData" border style="width: 100%" @selection-change="handleSelectionChange">
            ...
            <el-table-column align="center" label="模板图片" width="150">
            ...
            <el-table-column align="center" label="操作" width="180">
                <template scope="scope">
                    <router-link :to="'/template/2/'+scope.row.Id">
...
<script>
    export default {
        ...
        methods: {
        	//get为例子  
            myaxios: function() { 
                this.$http.post(this.HOST+"/template/Query",{qu:{index:this.cur_page,size:10},TemplateType:2})  
                .then(response => {  
