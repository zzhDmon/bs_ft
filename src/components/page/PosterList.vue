    ...
    <div class="table">
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item>房源模板</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="handle-box">
        	<router-link to="/template/1/-1">
            	<el-button type="primary" class="handle-del mr10">新增房源模板</el-button>
            </router-link>
        ...
        <el-table :data="testData" border style="width: 100%">
            ...
            <el-table-column align="center" label="操作" width="180">
                <template scope="scope">
                	<router-link :to="'/template/1/'+scope.row.Id">
...
//          this.getData();
        ...
        methods: {
        	//get为例子  
            myaxios: function() { 
                this.$http.post(this.HOST+"/template/Query",{qu:{index:this.cur_page,size:10},TemplateType:1})  
                .then(response => {  
